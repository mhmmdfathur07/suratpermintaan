...
<style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .form-card { max-width: 580px; background: #fff; border-radius: 18px; box-shadow: 0 8px 28px rgba(0,0,0,.07); padding: 36px 40px; }
    .form-card-title { font-size: 18px; font-weight: 800; color: #005654; margin-bottom: 24px; text-align: center; }
    .form-label { font-weight: 600; font-size: 13.5px; color: #333; margin-bottom: 6px; }
    .form-control, .form-select { border-radius: 10px; border: 1.5px solid #d0e8e7; font-size: 13.5px; transition: border-color .2s, box-shadow .2s; }
    .form-control:focus, .form-select:focus { border-color: #005654; box-shadow: 0 0 0 3px rgba(0,86,84,.1); outline: none; }
    .btn-update { display: flex; align-items: center; justify-content: center; gap: 6px; width: 100%; padding: 11px; background: #b8860b; color: #fff; font-size: 14px; font-weight: 700; border-radius: 10px; border: none; cursor: pointer; transition: background .2s, transform .15s; }
    .btn-update:hover { background: #9a7209; transform: translateY(-1px); }
...
<div class="main-wrapper">
    ...
    <div class="container-fluid px-4 px-md-5 py-4">
        ...
        <div class="form-card">
            <div class="form-card-title">Form Edit Layanan</div>
                ...
                <div class="mb-4">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="is_active"
                               id="is_active" value="1" {{ old('is_active', $layanan->is_active) ? 'checked' : '' }}>
