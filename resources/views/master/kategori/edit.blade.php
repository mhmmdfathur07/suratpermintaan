...
<div class="main-wrapper">
    ...
    <div class="container-fluid px-4 px-md-5 py-4">
        ...
        <form method="POST" action="{{ route('master.kategori.update', $kategori->id) }}">
            @csrf
            @method('PUT')
            <div class="form-card">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <input type="color" name="warna" class="form-control form-control-color"
                                   value="{{ old('warna', $kategori->warna) }}" style="width:60px;height:38px;padding:2px;border-radius:10px;">
